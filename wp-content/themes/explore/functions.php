...
function explore_setup() {
  ...
  wp_enqueue_style( 'explore-bootstrap', get_template_directory_uri() . '/css/bootstrap.css' );
  wp_enqueue_script('explore-bootstrapjs', get_template_directory_uri().'/js/bootstrap.min.js', array('jquery') );
...
function customized_widgets_init() {
  register_sidebar(array(
    'id'            => 'home-main-left',
    'name'          =>  __( 'Home Main Left', 'explore' ),
    'description'   =>  __( 'Used for footer widget area', 'explore' ),
    'before_widget' => '<div id="%1$s" class="widget %2$s home-box-content">',
    'after_widget'  => '</div>',
  ...
  register_sidebar(array(
    'id'            => 'home-main-right',
    'name'          =>  __( 'Home Main Right', 'explore' ),
    'description'   =>  __( 'Used for footer widget area', 'explore' ),
    'before_widget' => '<div id="%1$s" class="widget %2$s home-box-content">',
    'after_widget'  => '</div>',
    'before_title'  => '<h3 class="widgettitle">',
  ...
  register_sidebar(array(
    'id'            => 'youth-punctual-act',
    'name'          =>  __( 'Jovenes - Actividades puntuales', 'explore' ),
    'description'   =>  __( 'Used for footer widget area', 'explore' ),
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h3 class="widgettitle">',
  ...
  register_sidebar(array(
    'id'            => 'youth-general-act',
    'name'          =>  __( 'Jovenes - Actividades generales', 'explore' ),
    'description'   =>  __( 'Used for footer widget area', 'explore' ),
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h3 class="widgettitle">',
  ...
  register_sidebar(array(
    'id'            => 'sr-punctual-act',
    'name'          =>  __( 'Adultos - Actividades puntuales', 'explore' ),
    'description'   =>  __( 'Used for footer widget area', 'explore' ),
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h3 class="widgettitle">',
  ...
  register_sidebar(array(
    'id'            => 'sr-general-act',
    'name'          =>  __( 'Adultos - Actividades generales', 'explore' ),
    'description'   =>  __( 'Used for footer widget area', 'explore' ),
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget'  => '</div>',
    'before_title'  => '<h3 class="widgettitle">',
