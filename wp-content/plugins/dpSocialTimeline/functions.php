...
add_action( 'wp_ajax_nopriv_timeline_createCookie', 'dpSocialTimeline_createCookie' );
add_action( 'wp_ajax_timeline_createCookie', 'dpSocialTimeline_createCookie' );
function dpSocialTimeline_createCookie() {
	if(!isset($_POST['data'])) { die(); }
	...
	$dpSocialTimeline = new DpSocialTimeline( false, $timeline_id );
	
	$dpSocialTimeline->saveCache($data);
}

add_action( 'wp_ajax_nopriv_timeline_deleteCookie', 'dpSocialTimeline_deleteCookie' );
add_action( 'wp_ajax_timeline_deleteCookie', 'dpSocialTimeline_deleteCookie' );
function dpSocialTimeline_deleteCookie() {
